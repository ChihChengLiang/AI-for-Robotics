...
def doit(initial_pos, move1, move2):
    ...
    # move1
    omega=omega.expand(omega.dimx+1,omega.dimx+1, [0],[0])
    
    omega.value[omega.dimx-2][omega.dimy-2]+=1
    omega.value[omega.dimx-2][omega.dimy-1]+=-1
    omega.value[omega.dimx-1][omega.dimy-2]+=-1
    omega.value[omega.dimx-1][omega.dimy-1]+=1
    xi=xi.expand(xi.dimx+1,xi.dimy,[0])
    xi.value[xi.dimx-2][0]+=-move1
    xi.value[xi.dimx-1][0]+=move1
    
    #move2
    omega=omega.expand(omega.dimx+1,omega.dimy+1, [0,1],[0,1])
    ...
    xi=xi.expand(xi.dimx+1,xi.dimy,[0,1],[0])
    xi.value[xi.dimx-2][0]+=-move2
    xi.value[xi.dimx-1][0]+=move2
