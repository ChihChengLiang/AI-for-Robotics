...
class robot:
    ...
    def sense(self): #do not change the name of this function
        ...
        Z=[(atan2(l[0]-self.y,l[1]-self.x)-self.orientation) %(2*pi) for l in landmarks]
...
#print 'Correct answer:[6.004885648174475, 3.7295952571373605, 1.9295669970654687, 0.8519663271732721]'
